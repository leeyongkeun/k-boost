    ...
    <div className="min-h-dvh flex flex-col items-center px-6 py-10 relative overflow-hidden">
      ...
      <div className="relative z-[2] flex items-center justify-center flex-1 w-full my-4 animate-[fadeIn_1s_ease-out_0.3s_both]">
        <div className="relative flex items-center justify-center w-full h-full">
          ...
          {/* Rocket */}
          <div className="leading-none animate-rocket-float relative z-[2] drop-shadow-[0_0_50px_rgba(197,3,55,0.35)] drop-shadow-[0_25px_60px_rgba(2,28,79,0.7)]">
            <img
              src="/rocket.svg"
              alt="rocket"
              className="w-[min(20dvh,130px)] h-auto"
            />
          </div>
          {/* Trail */}
